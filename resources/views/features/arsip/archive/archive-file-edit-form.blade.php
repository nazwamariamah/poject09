<x-app-layout>
    ...
    <div class="#">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
            <a href="{{ route('folder.show', $file->folder_id) }}"
    ...
    <div class="py-8 bg-gray-50 min-h-screen">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-md sm:rounded-md p-8 border border-gray-200">
                ...
                {{-- FORM --}}
                <form action="{{ route('archive.update', $file->id) }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" name="tgl_invoice"   value="{{ old('tgl_invoice', $file->tgl_invoice) }}"
                                class="w-full font-semibold text-gray-900 bg-transparent border-b border-gray-300
                            ...
                            <div class="relative overflow-hidden rounded-xl border border-green-200 bg-white p-5 shadow-sm">
                                <div class="flex items-center justify-between gap-4">
                                    ...
                                    <div class="flex-shrink-0">
                                        <a href="{{ route('archive.stream', $file->id) }}" target="_blank"
