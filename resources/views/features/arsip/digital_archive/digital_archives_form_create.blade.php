        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-md sm:rounded-md p-8 border border-gray-200">
                ...
                <div class="mb-8 pb-4 border-b border-gray-200">
                    <h3 class="text-xl font-semibold text-gray-800">Form Buat Arsip Digital</h3>
                    <p class="text-sm text-gray-600 mt-1">Buat arsip digital dengan benar dan teliti.</p>
                </div>

                {{-- FORM --}}
                <form action="{{ route('digital.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="digital_name"
                        ...
                        <div>
                            ...
                            <input type="text" name="digital_code"
                        ...
                        <div>
                            ...
                            <input type="text" name="from_division"
                                class="w-full text-gray-800 px-4 py-2.5 bg-gray-50 rounded-md border border-gray-200
                                focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                        ...
                        <div>
                            ...
                            <input type="number" name="nilai_sp2d"
                                class="w-full text-gray-800 px-4 py-2.5 bg-gray-50 rounded-md border border-gray-200
                                focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                        ...
                        <div>
                            ...
                            <input type="text" name="jenis_sp2d"
                                class="w-full text-gray-800 px-4 py-2.5 bg-gray-50 rounded-md border border-gray-200
                                focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                    ...
                    <div class="pt-6 border-t border-gray-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="submiter_name"
                            ...
                            <div>
                                ...
                                <input type="text" name="finance_officer_name"
                            ...
                            <div>
                                ...
                                <input type="text" name="revenue_officer_name"
                    ...
                    <div class="pt-6 border-t border-gray-200">
                        ...
                        <textarea name="keterangan" rows="3"
                            ...
                            focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                            placeholder="Keterangan tambahan atau catatan mengenai arsip"></textarea>
                        @error('keterangan')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
